    ...
    return Scaffold(
      body: Column(
        children: [
              ...
              child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Image.asset("assets/images/password.png",height: size.height * 0.2,),
                    ),
                    SizedBox(
                      height: 20,
                    ),
          ...
          Container(margin: EdgeInsets.only(left: size.width * 0.05,right: size.width * 0.05),
          ...
          Container(
                ...
                FlatButton(child: Text("resend otp"),onPressed: (){},)
        ],
      ),
    );
  }
