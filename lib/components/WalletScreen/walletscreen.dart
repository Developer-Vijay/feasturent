              ...
              child: ListView(
                    children: [
                      Container(
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: Container(
                                    margin:
                                        EdgeInsets.only(left: mediaheight40),
                                    child: CircleAvatar(
                                      radius: 28,
                                      child: Image.asset(
                                ...
                                Column(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child:
                                          Text("Sent", style: walletIconStyle),
                                    ),
                                  ],
                                ),
                                SizedBox(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      margin: EdgeInsets.only(
                                          ...
                                          top: size.width * 0.01),
                                      child:
                                          Text("Loan", style: walletIconStyle),
                                    ),
                                  ],
                                ),
                                SizedBox(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      margin: EdgeInsets.only(
                                          ...
                                          right: size.width * 0.04),
                                      child:
                                          Text("Topup", style: walletIconStyle),
                                    ),
                                  ],
                                )
                              ],
                        ...
                        Container(color: Colors.grey[350].withOpacity(0.5),
                          child: Row(
                                    children: [
                                      Container( 
                                        margin: EdgeInsets.only(
                                ...
                                Container(                                    height: mediaheight40,
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          SizedBox(
                                            width: 80,
                                            child: Text(
                                              "${wallet['Payments'][index1]['PaymentTransactions'][0]['transactionFor']}",
                                              style: TextStyle(
                                                  fontSize: 15,
                                                  color: Colors.black,
                                                  fontWeight: FontWeight.bold),
                                          ...
                                          Text(
                                            "${wallet['Payments'][index1]['PaymentTransactions'][0]['transactionType']}",
                                            style: TextStyle(
                                                fontSize: 10,
                                                color: Colors.grey,
                                                fontWeight: FontWeight.bold),
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: Column(
                                          children: [
                                            Text(
                                              "${wallet['Payments'][index1]['PaymentTransactions'][0]['transactionAmount']} ₹ -",
                                              style: TextStyle(
                                            ...
                                            Padding(
                                              padding: const EdgeInsets.only(
                                                  left: 41.0),
                                              child: Text(
                                                "${wallet['Payments'][index1]['PaymentTransactions'][0]['createdAt']}",
                                                style: TextStyle(
                                                    color: Colors.grey,
                                                    fontSize: 10,
                                                    fontWeight:
