...
String googleAPIKey = "AIzaSyCg54XwhQZYIkN7gpaj3wy9__mxvYQB6oE";
...
class _MapViewState extends State<MapView> {
  ...
  _createPolylines(s, g) async {
    polylinePoints = PolylinePoints();
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
      googleAPIKey, // Google Maps API Key
      PointLatLng(28.834439600000003, 77.5698527),
      PointLatLng(30.375321000000003, 30.375321000000003),
